...
class Notification
{
     ...
     * @return static
     */
    public function withAddedAction(string $text, string|Stringable $url, array $attributes = []): static
    {
        $new = clone $this;
        $new->actions[] = new NotificationAction($text, (string)$url, $attributes);
        return $new;
    }
